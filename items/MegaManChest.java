...
/* 14 */     this.textureId = 22;
/*    */   }
/*    */ 
/*    */   public String getArmorTextureFile(ItemStack par1)
/*    */   {
/* 21 */     if ((par1.id == FunMod.MegaManChest.id) || (par1.id == FunMod.MegaManChest.id) || 
/* 22 */       (par1.id == FunMod.MegaManChest.id))
/* 23 */       return "/FunMod/cliente/texturas/armaduras/mega_1.png";
/* 24 */     if (par1.id == FunMod.MegaManChest.id)
