            ...
            for (int l1 = j; l1 <= i1; l1++)
            {
                ...
                for (int i2 = k; i2 <= j1; i2++)
                {
                    ...
                    for (int j2 = l; j2 <= k1; j2++)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && par1World.getTypeId(l1, i2, j2) == FunMod.FantasyStone.id)
                        {
                            par1World.setRawTypeIdAndData(l1, i2, j2, minableid, metadata);
                        }
                    }
                }
            }
